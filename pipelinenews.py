...
#SENTIMENTS
#$ python pipelinenews.py Elasticsearch --filename footballnews --index footballnews --doc-type news --local-scheduler
        ...
        with self.output().open('w') as output:
            with self.input().open('r') as infile:
                ...
                for i in j:
                    ...
                    #http://senpy.cluster.gsi.dit.upm.es/api/?algo=affect&sentiplug=meaningCloud&meaningCloud-key=17b04c0b21d4bb9f6b30c54499dbdea8&emoplug=EmoTextANEW&language=es&i=
                    r = requests.post("http://senpy.cluster.gsi.dit.upm.es/api/", data={'input': i["articleBody"], 'algo': 'affect', 'sentiplug': 'meaningCloud', 'meaningCloud-key': '17b04c0b21d4bb9f6b30c54499dbdea8', 'emoplug': 'EmoTextANEW', 'language': 'es'})
